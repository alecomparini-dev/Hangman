...
//  MARK: - LAZY AREA
    ...
    lazy var discountStack: StackViewBuilder = {
        let comp = StackViewBuilder()
            ...
            .setConstraints { build in
                build
                    .setTop.setBottom.equalToSuperView(6)
...
//        comp.get.transform = CGAffineTransform(rotationAngle: -35.degreesToPI )
        return comp
    }()
    ...
    lazy var chevronRightImage: ImageViewBuilder = {
        let comp = ImageViewBuilder(systemName: "chevron.compact.right")
            ...
            .setConstraints { build in
                build
                    .setVerticalAlignmentY.equalToSuperView
                    .setTrailing.equalToSuperView(-6)
            }
    ...
    private func configNeumorphism() {
        self
            .setNeumorphism { build in
                build
                    .setReferenceColor(Theme.shared.currentTheme.error.adjustBrightness(100))
                    .setShape(.flat)
